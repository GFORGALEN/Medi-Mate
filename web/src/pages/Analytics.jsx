                        ...
                        {selectedManufacturer && (
                            <Col span={24}>
                                <Card title="Brand Insights">
                                    ...
                                    <Paragraph>
                                        Average Price: ${(filteredProducts.reduce((sum, product) => sum + parseFloat(product.productPrice), 0) / filteredProducts.length).toFixed(2)}
                                    </Paragraph>
                                    <Paragraph>
                                        Price Range: ${Math.min(...filteredProducts.map(p => parseFloat(p.productPrice))).toFixed(2)} - ${Math.max(...filteredProducts.map(p => parseFloat(p.productPrice))).toFixed(2)}
                                    </Paragraph>
                                </Card>
                            </Col>
                        )}
