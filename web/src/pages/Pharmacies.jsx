...
import PharmacyMapWithCards from '@/pages/PharmacyCard.jsx';
...
const Pharmacies = () => {
    ...
    return (
        <div className="relative w-full h-screen">
            <PharmacyMapWithCards
                onPharmaciesLoaded={handlePharmaciesLoaded}
                currentIndex={currentIndex}
            />

            {pharmacies[currentIndex] && (
                <div className="absolute top-4 left-1/2 transform -translate-x-1/2 w-8/12 md:w-1/2 lg:w-4/12 lg:h-1/8 bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 ease-in-out">
